...
public class TNG_002 extends BaseTest
{
  ...
  public void amazon() 
  {
	  System.out.println("amazon");
		...
		test.log(Status.INFO, "Selecting the option Books By using the locator : " + orProp.getProperty("amazondropbox_id"));
				
		typeText("amazonsearchtext_id","Harry Potter");
		test.log(Status.FAIL,"Entering Text Harry Potter By using locator : " + orProp.getProperty("amazonsearchtext_id"));
